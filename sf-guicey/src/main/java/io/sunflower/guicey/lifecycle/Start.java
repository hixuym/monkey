...
public @interface Start {
   ...
   * 20-80 - Services that depend on resources, but don't actually commit the app doing its core functions
   * 90 - Services that commit the app doing its core functions, for example, listen on queues, listen for HTTP, commit
   * scheduled services
   *
