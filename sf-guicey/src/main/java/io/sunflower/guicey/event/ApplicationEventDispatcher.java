...
public interface ApplicationEventDispatcher {
  ...
  <T extends ApplicationEvent> ApplicationEventRegistration registerListener(Class<T> eventType,
      ApplicationEventListener<T> eventListener);

  ApplicationEventRegistration registerListener(
  ...
  void fire(ApplicationEvent event);
