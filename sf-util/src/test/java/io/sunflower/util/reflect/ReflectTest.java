 ...
 */
package io.sunflower.util.reflect;

import io.sunflower.util.Reflect;
import io.sunflower.util.ReflectException;
...
import static io.sunflower.util.Reflect.accessible;
import static io.sunflower.util.Reflect.on;
...
public class ReflectTest {
    ...
    public void testMethods() {
        ...
        assertEquals(2.0f, (Float) on((Object) "1234").call("indexOf", "3").call("floatValue").get(),
                0.0f);
    ...
    public void testPublicMethodsAreFoundInHierarchy() throws Exception {
        ...
        assertEquals(TestHierarchicalMethodsBase.PUBLIC_RESULT,
                on(subclass).call("pub_base_method", 1).get());
    }
    ...
    public void testPrivateMethodsAreFoundOnDeclaringClass() throws Exception {
        TestHierarchicalMethodsSubclass subclass = new TestHierarchicalMethodsSubclass();
        assertEquals(TestHierarchicalMethodsSubclass.PRIVATE_RESULT,
                on(subclass).call("priv_method", 1).get());

        TestHierarchicalMethodsBase baseClass = new TestHierarchicalMethodsBase();
        assertEquals(TestHierarchicalMethodsBase.PRIVATE_RESULT,
                on(baseClass).call("priv_method", 1).get());
    }
    ...
    public void testFields() throws Exception {
        ...
        assertEquals(1,
                accessible(TestHierarchicalMethodsBase.class.getDeclaredField("invisibleField1"))
                        .get(test2));

        assertEquals(1, (int) (Integer) on(test2).set("invisibleField2", 1).get("invisibleField2"));
        assertEquals(0,
                accessible(TestHierarchicalMethodsBase.class.getDeclaredField("invisibleField2"))
                        .get(test2));
        assertEquals(1,
                accessible(TestHierarchicalMethodsSubclass.class.getDeclaredField("invisibleField2"))
                        .get(test2));

        assertEquals(1, (int) (Integer) on(test2).set("invisibleField3", 1).get("invisibleField3"));
        assertEquals(1,
                accessible(TestHierarchicalMethodsSubclass.class.getDeclaredField("invisibleField3"))
                        .get(test2));

        assertEquals(1, (int) (Integer) on(test2).set("visibleField1", 1).get("visibleField1"));
        assertEquals(1,
                accessible(TestHierarchicalMethodsBase.class.getDeclaredField("visibleField1")).get(test2));

        assertEquals(1, (int) (Integer) on(test2).set("visibleField2", 1).get("visibleField2"));
        assertEquals(0,
                accessible(TestHierarchicalMethodsBase.class.getDeclaredField("visibleField2")).get(test2));
        assertEquals(1,
                accessible(TestHierarchicalMethodsSubclass.class.getDeclaredField("visibleField2"))
                        .get(test2));

        assertEquals(1, (int) (Integer) on(test2).set("visibleField3", 1).get("visibleField3"));
        assertEquals(1,
                accessible(TestHierarchicalMethodsSubclass.class.getDeclaredField("visibleField3"))
                        .get(test2));
