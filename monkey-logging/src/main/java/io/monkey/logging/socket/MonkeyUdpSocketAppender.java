 ...
 */
public class MonkeyUdpSocketAppender<E extends DeferredProcessingAware> extends OutputStreamAppender<E> {

    private final String host;
    private final int port;

    public MonkeyUdpSocketAppender(String host, int port) {
        this.host = host;
        this.port = port;
    }
