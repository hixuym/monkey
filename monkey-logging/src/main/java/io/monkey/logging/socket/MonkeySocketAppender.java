package io.monkey.logging.socket;
 ...
 */
public class MonkeySocketAppender<E extends DeferredProcessingAware> extends OutputStreamAppender<E> {
    ...
    public MonkeySocketAppender(String host, int port, int connectionTimeoutMs, int sendBufferSize,
