...
import io.monkey.logging.filter.ThresholdLevelFilterFactory;
...
public class DefaultLoggingFactory implements LoggingFactory {
    ...
    public void configure(MetricRegistry metricRegistry, String name) {
        ...
        final LayoutFactory<ILoggingEvent> layoutFactory = new MonkeyLayoutFactory();
    ...
    public void reset() {
        ...
        try {
            ...
            final Logger logger = loggerContext.getLogger(org.slf4j.Logger.ROOT_LOGGER_NAME);
            logger.detachAndStopAllAppenders();
            final MonkeyLayout formatter = new MonkeyLayout(loggerContext, TimeZone.getDefault());
            formatter.start();
