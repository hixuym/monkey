...
/**
 * @author Michael
 * Created at: 2019/1/4 12:26
 */
public class BasicServiceConfigFactory extends AbstractInterfaceConfigFactory {
    ...
    public BasicServiceInterfaceConfig buildBasicService() {

        BasicServiceInterfaceConfig basicServiceInterfaceConfig = new BasicServiceInterfaceConfig();

        apply(basicServiceInterfaceConfig);

        basicServiceInterfaceConfig.setExport(export);
        basicServiceInterfaceConfig.setHost(host);

        return basicServiceInterfaceConfig;
    }

    public ServiceConfig buildService() {
