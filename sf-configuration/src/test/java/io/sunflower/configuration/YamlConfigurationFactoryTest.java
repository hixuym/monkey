...
public class YamlConfigurationFactoryTest extends BaseConfigurationFactoryTest {
  ...
  public void setUp() throws Exception {
    this.factory = new YamlConfigurationFactory<>(Example.class, validator,
    ...
    try {
      ...
      assertThat(e)
          .hasMessageContaining(
              " * Failed to parse configuration; Cannot construct instance of `io.sunflower.configuration.BaseConfigurationFactoryTest$Example`");
    }
  }
