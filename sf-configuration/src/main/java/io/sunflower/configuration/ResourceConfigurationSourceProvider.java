...
/**
 * An implementation of {@link ConfigurationSourceProvider} which reads the configuration from a
 * resource file. <p> In order to abide by the calling conventions of
 * {ClassLoader#getResourceAsStream} [1], absolute path strings (i.e. those with leading "/"
