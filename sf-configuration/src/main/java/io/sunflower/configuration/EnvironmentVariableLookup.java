...
/**
 * A custom {@link StrLookup} implementation using environment variables as lookup
 * source.
 */
public class EnvironmentVariableLookup extends StrLookup<Object> {
     ...
     * @throws UndefinedEnvironmentVariableException if the environment variable doesn't exist and strict behavior is
     *                                               enabled.
     */
