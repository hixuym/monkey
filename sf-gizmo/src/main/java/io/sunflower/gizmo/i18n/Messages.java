...
public interface Messages {
    ...
    /**
     * @param language The language to get. May be absent - then the default language is returned. It also looks for a
     *                 fallback. Eg. A request for "en-US" will fallback to "en" if there is no matching language file.
     *
     ...
     * @deprecated Might be removed from further releases. Usually is not implemented in a thread safe way and is error
     * prone.
     *
     * Returns all messages for a language we have. Please note that this method does NOT format any MessageFormat
     * values. You have to do that yourself in the controller logic most likely.
     *
     * Note: If you don't want to determine the language yourself please use {@link Messages#getAll(Context, Optional)}
     */
    @Deprecated
