...
public interface Router {
     ...
     *      URL-escape path or query parameters. Use <code>ReverseRouter</code>
     *      to build your reverse routes.
     */
    @Deprecated
    String getReverseRoute(Class<?> clazz, String methodName);
     ...
     */
    @Deprecated
    String getReverseRoute(Class<?> clazz, String methodName, Map<String, Object> parameterMap);
     ...
     */
    @Deprecated
    String getReverseRoute(Class<?> clazz, String methodName, Object... parameterMap);
     ...
     */
    @Deprecated
    String getReverseRoute(MethodReference controllerMethodRef, Map<String, Object> parameterMap);
     ...
     */
    @Deprecated
    String getReverseRoute(MethodReference controllerMethodRef, Object... parameterMap);
     ...
     */
    @Deprecated
    String getReverseRoute(MethodReference controllerMethodRef, Optional<Map<String, Object>> parameterMap);
