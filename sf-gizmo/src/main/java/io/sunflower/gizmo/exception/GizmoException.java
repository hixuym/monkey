...
package io.sunflower.gizmo.exception;
...
public class GizmoException extends RuntimeException {
    ...
    public GizmoException(int httpStatus, String httpMessage) {
        super(httpMessage);
        this.httpStatus = httpStatus;
    }

    public GizmoException(int httpStatus, String httpMessage, Throwable cause) {
