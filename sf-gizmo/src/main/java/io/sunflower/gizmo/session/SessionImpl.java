...
public class SessionImpl implements Session {
    ...
    @Inject
    public SessionImpl(Crypto crypto, CookieEncryption encryption, GizmoConfiguration configuration, Clock clock) {
        ...
        String applicationCookiePrefix = configuration
            .getCookiePrefix();
        this.sessionCookieName = applicationCookiePrefix + NinjaConstant.SESSION_SUFFIX;
    }
