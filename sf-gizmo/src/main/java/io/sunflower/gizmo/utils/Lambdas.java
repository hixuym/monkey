...
public class Lambdas {
  ...
  /**
   * The kind of lambda.  Lambdas in Java can either be references to methods or anonymously
   * defined. https://docs.oracle.com/javase/tutorial/java/javaOO/methodreferences.html
   */
  public enum Kind {
  ...
  public static class LambdaInfo {
    ...
    public LambdaInfo(Object lambda, Kind kind, SerializedLambda serializedLambda,
        Method functionalMethod, Method implementationMethod) {
      this.lambda = lambda;
      this.kind = kind;
   ...
   * <code>writeReplace</code> method.  The lambda must be serializable in order for this method to
   * return a value.
   *
  ...
  public static SerializedLambda getSerializedLambda(Object lambda) {
    ...
    if (!(lambda instanceof java.io.Serializable)) {
      throw new IllegalArgumentException(
          "Functional object does not implement java.io.Serializable");
    }
  ...
  public static Method getFunctionalMethod(SerializedLambda serializedLambda)
      throws NoSuchMethodException, ClassNotFoundException {
    return getMethod(serializedLambda.getFunctionalInterfaceClass(),
        serializedLambda.getFunctionalInterfaceMethodName());
  }

  public static Method getImplementationMethod(SerializedLambda serializedLambda)
      throws NoSuchMethodException, ClassNotFoundException {
