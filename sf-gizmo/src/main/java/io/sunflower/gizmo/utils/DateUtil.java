...
public class DateUtil {
    ...
    public static String formatForHttpHeader(Long unixTime) {
        ...
        return DateTimeFormatter.RFC_1123_DATE_TIME.withZone(ZoneId.of("GMT")).format(Instant.ofEpochMilli(unixTime));
    }
    ...
    public static Date parseHttpDateFormat(String httpDateFormat) throws IllegalArgumentException {
        return Dates.asUtilDate(LocalDateTime.parse(httpDateFormat, DateTimeFormatter.RFC_1123_DATE_TIME), ZoneId.of("GMT"));
    }
}
