...
/**
 * This interface means the validation context (implemented by {@link}) and can be injected in your
 * controller method.
 ...
 * Each violation on a field (parameter or in an annotated bean) results in a {@link}. This makes it
