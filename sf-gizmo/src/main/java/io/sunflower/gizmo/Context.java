...
import io.sunflower.gizmo.uploads.FileItemProvider;
import io.sunflower.gizmo.uploads.FileProvider;
...
public interface Context {
     ...
     */
    String NINJA_PROPERTIES_X_FORWARDED_FOR = "ninja.x_forwarded_for_enabled";
     ...
     * @deprecated This method is kept for backward compatibility, use {@link FileProvider} to specify which {@link
     * FileItemProvider} should be used to handle uploaded files, and access them using {@link
     * #getParameterAsFileItem(String)}.
     */
    @Deprecated
