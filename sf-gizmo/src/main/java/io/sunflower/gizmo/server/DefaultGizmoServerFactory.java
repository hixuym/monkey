    ...
    public GizmoServer buildServer(Environment environment) {
        ...
        for (ConnectorFactory connectorFactory : getApplicationConnectors()) {
            ...
            if (Strings.isNullOrEmpty(getApplicationContextPath())) {
                ...
                listenerBuilder.setRootHandler(new PathHandler().addPrefixPath(getApplicationContextPath(), applicationHandler));
            }
        ...
        for (ConnectorFactory connectorFactory : getAdminConnectors()) {
            ...
            if (Strings.isNullOrEmpty(getAdminContextPath())) {
                ...
                listenerBuilder.setRootHandler(new PathHandler().addPrefixPath(getAdminContextPath(), adminHandler));
            }
