...
public class UndertowHelper {
    ...
    static public void createOrMerge(Map<String, String[]> parameters, String name, Deque<FormValue> formValues) {
    ...
    /**
     * Creates a new {@link ParameterFileItem} from the given {@link FormValue} (which is assumed to be representing a
     * file upload).
     */
