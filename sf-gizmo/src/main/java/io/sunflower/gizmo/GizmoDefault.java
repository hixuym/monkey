...
import io.sunflower.gizmo.exception.BadRequestException;
import io.sunflower.gizmo.exception.RenderingException;
import io.sunflower.gizmo.i18n.Messages;
import io.sunflower.gizmo.util.Message;
...
public class GizmoDefault implements Gizmo {
    ...
    public Result getInternalServerErrorResult(Context context, Exception exception, Result underlyingResult) {
        ...
        Result result = Results
                ...
                .render(message)
                .template(ninjaProperties.getWithDefault(
     ...
     * Gizmo build. Helps to identify the Gizmo version currently running.
     * 
