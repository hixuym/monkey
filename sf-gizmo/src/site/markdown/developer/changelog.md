 ...
 * 2017-05-05 Make scheduling support a feature of `NinjaClassicModule` #572 (patrickabner)
 ...
 * 2016-12-19 New `ReverseRouter` for validated, URL-safe reverse routing using Java 8 lambda expressions in addition to legacy Class + method name references. (jjlauer)
 ...
 * 2016-02-28 More flexible Ninja guice configuration! Your `conf.Module` can optionally extend 
              `FrameworkModule` to skip Ninja's default guice bindings
              for its "classic" stack of Freemarker, Jackson, Cache, etc. (jjlauer)
 * 2016-02-28 New `NinjaClassicModule` guice module to aid power users
 ...
 * 2014-12-14 #257 Add protocol to Context (chrsin)
...
=============
  ...
  * 2014-03-05 #155 Fixed glitch were Freemarker did not emit a proper 400 when
               template not found.
  * 2014-03-05 Fix so that configuration.getContextPath() and context.getContextPath() 
