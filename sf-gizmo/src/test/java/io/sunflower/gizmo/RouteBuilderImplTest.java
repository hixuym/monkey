...
public class RouteBuilderImplTest {
  ...
  @Before
  public void before() {
    this.routeBuilder = new RouteBuilderImpl();
  }
...
//    }
  ...
  public void routeWithResult() {
    ...
    routeBuilder.GET().route("/directly_result/route")
        .with(() -> Results.html().template(template));
  ...
  public void testWithFiltersList() throws Exception {
    ...
    routeBuilder.GET().route("/").filters(Lists.newArrayList(DummyFilter.class))
        .with(() -> expectedResult);
    Route route = routeBuilder.buildRoute(injector);
  ...
  public void testWithGlobalFiltersList() throws Exception {
    ...
    routeBuilder.GET().route("/").globalFilters(Lists.newArrayList(DummyFilter.class))
        .with(() -> expectedResult);
    Route route = routeBuilder.buildRoute(injector);
