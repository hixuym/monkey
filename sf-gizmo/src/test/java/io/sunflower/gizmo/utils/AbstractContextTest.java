...
public class AbstractContextTest {
    ...
    @Mock
    private GizmoConfiguration ninjaProperties;
    ...
    public void getRemoteAddrIgnoresXForwardHeader() {
        ...
        when(ninjaProperties.isUsageOfXForwardedHeaderEnabled()).thenReturn(Boolean.FALSE);
        doReturn("1.1.1.1").when(context).getRealRemoteAddr();
    ...
    public void getRemoteAddrUsesXForwardHeader() {
        ...
        when(ninjaProperties.isUsageOfXForwardedHeaderEnabled()).thenReturn(Boolean.TRUE);
        doReturn("1.1.1.1").when(context).getRealRemoteAddr();
        doReturn("2.2.2.2").when(context).getHeader(Context.X_FORWARD_HEADER);
