 ...
 *
 * Also really important because we want to make sure that our client side session mechanism is
 * widely used and stable. We don't want to reinvent the wheel of securely encoding / decoding and
 * signing cookie data.
 *
