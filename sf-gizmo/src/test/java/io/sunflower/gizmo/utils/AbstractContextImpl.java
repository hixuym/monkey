...
public class AbstractContextImpl extends AbstractContext {
    ...
    public AbstractContextImpl(BodyParserEngineManager bodyParserEngineManager, FlashScope flashScope, GizmoConfiguration configuration, Session session, Validation validation, Injector injector, ParamParsers paramParsers) {
        super(bodyParserEngineManager, flashScope, configuration, session, validation, injector, paramParsers);
    }
