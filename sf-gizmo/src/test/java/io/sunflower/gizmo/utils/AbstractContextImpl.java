...
public class AbstractContextImpl extends AbstractContext {
    ...
    public AbstractContextImpl(BodyParserEngineManager bodyParserEngineManager, FlashScope flashScope, GizmoConfiguration ninjaProperties, Session session, Validation validation, Injector injector, ParamParsers paramParsers) {
