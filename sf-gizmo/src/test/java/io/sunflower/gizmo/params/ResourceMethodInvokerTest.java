...
//        when(context.getHeader("param1")).thenReturn(null);
    ...
    public void customDateFormatParamWithOptionalShouldBeParsedToDate() throws Exception {
        ...
        verify(mockController).dateParamWithOptional(Optional.of(Dates.asUtilDate(LocalDateTime.of(2015, 1, 15, 0, 0))));
    }
...
//        when(context.getParameter("param1")).thenReturn("hello");
    ...
    public void needingInjectionParamParserArray() throws Exception {
        ...
        verify(mockController).needingInjectionParamParserArray(new Dep[]{new Dep("SF__hello1"), new Dep("SF__hello2")});
    }
...
//        when(context.getParameter("param1")).thenReturn(null);
    ...
    public void optionalDateParam() {
        ...
        verify(mockController).optionalDateParam(Optional.of(Dates.asUtilDate(LocalDateTime.of(2015, 1, 15, 0, 0))));
    }
    ...
    private void doCheckValidationFailedTranslationFr(Context context) {
        ...
        assertEquals(this.context.getValidation().getViolations().get(0).getDefaultMessage(), "la taille doit être comprise entre 5 et 10");
    }
    ...
    public interface MockController {
        ...
        Result guiceArgumentExtractorWithOptional(@GuiceAnnotation(foo = "bar") Optional<String> param1);
        ...
        Result badValidatorWithOptional(@Param("param1") @NumberValue(min = 10) Optional<String> param1);
    ...
    /**
     * Argument extractor that has a complex constructor for Guice. It depends on some other dependency (dep), plus the
     * annotation that was on the parameter, and the class of the parameter.
     */
