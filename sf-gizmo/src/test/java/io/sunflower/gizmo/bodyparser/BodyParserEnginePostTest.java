...
public class BodyParserEnginePostTest {
  ...
  public void testBodyParser() {
    ...
    String dateTimeString = "2014-10-10 20:09:10";
    ...
    assertThat(testObject.date, equalTo(Dates.asUtilDate(LocalDate.parse(dateString))));
    assertThat(testObject.timestamp, equalTo(Dates.asUtilDate(
  ...
  public void testBodyParserWithValidationErrors() {
    ...
    assertViolation("integerPrimitive", GizmoConstant.INT_KEY);
    assertThat(testObject.integerPrimitive, equalTo(0));
    assertViolation("integerObject", GizmoConstant.INT_KEY);
    assertNull(testObject.integerObject);
    assertViolation("longPrimitive", GizmoConstant.INT_KEY);
    assertThat(testObject.longPrimitive, equalTo(0L));
    assertViolation("longObject", GizmoConstant.INT_KEY);
    assertNull(testObject.longObject);
    assertViolation("floatPrimitive", GizmoConstant.FLOAT_KEY);
    assertThat(testObject.floatPrimitive, equalTo(0F));
    assertViolation("floatObject", GizmoConstant.FLOAT_KEY);
    assertNull(testObject.floatObject);
    assertViolation("doublePrimitive", GizmoConstant.FLOAT_KEY);
    assertThat(testObject.doublePrimitive, equalTo(0D));
    assertViolation("doubleObject", GizmoConstant.FLOAT_KEY);
    assertNull(testObject.doubleObject);

    assertViolation("date", GizmoConstant.DATE_KEY);
    assertNull(testObject.date);
    assertViolation("timestamp", GizmoConstant.DATE_KEY);
  ...
  public void testBodyParserWhenThereIsAnUnsupportedFieldType() {
    ...
    // do
    TestObjectWithUnsupportedFields testObject = bodyParserEnginePost
        .invoke(context, TestObjectWithUnsupportedFields.class);
  ...
  public void testBodyParserWithCollectionAndArray() {
    ...
    // do
    TestObjectWithArraysAndCollections testObject = bodyParserEnginePost
        .invoke(context, TestObjectWithArraysAndCollections.class);
  ...
  public void testBodyParserWithCustomNeedingInjectionParamParser() {
    ...
    // do
    TestObjectWithCustomType testObject = bodyParserEnginePost
    ...
    assertThat(testObject.depList.get(0),
        equalTo(new ResourceMethodInvokerTest.Dep("SF__depList1")));
    assertThat(testObject.depList.get(1),
        equalTo(new ResourceMethodInvokerTest.Dep("SF__depList2")));
...
//        Mockito.when(context.getParameter("object2.integerObject")).thenReturn("4000");
    ...
    // do
    TestObjectWithInnerObjects testObject = bodyParserEnginePost
        .invoke(context, TestObjectWithInnerObjects.class);
