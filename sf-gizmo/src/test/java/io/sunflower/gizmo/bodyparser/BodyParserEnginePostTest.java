...
import io.sunflower.gizmo.utils.NinjaPropertiesImpl;
...
public class BodyParserEnginePostTest {
    ...
    public void testBodyParserWithCustomNeedingInjectionParamParser() {
        ...
        // and test:
        assertThat(testObject.dep, equalTo(new ControllerMethodInvokerTest.Dep("hello_dep1")));

        assertNotNull(testObject.depArray);
        assertThat(testObject.depArray.length, equalTo(2));
        assertThat(testObject.depArray[0], equalTo(new ControllerMethodInvokerTest.Dep("hello_depArray1")));
        assertThat(testObject.depArray[1], equalTo(new ControllerMethodInvokerTest.Dep("hello_depArray2")));

        assertNotNull(testObject.depList);
        assertThat(testObject.depList.size(), equalTo(2));
        assertThat(testObject.depList.get(0), equalTo(new ControllerMethodInvokerTest.Dep("hello_depList1")));
        assertThat(testObject.depList.get(1), equalTo(new ControllerMethodInvokerTest.Dep("hello_depList2")));
