...
public class ReverseRouterTest {
    ...
    public void before() {
        this.configuration = mock(GizmoConfiguration.class);
        ...
        when(routeBuilderImplProvider.get()).thenAnswer((invocation) -> new RouteBuilderImpl(ninjaBaseDirectoryResolver));
    ...
    public void simpleWithContext() {
        ...
        when(configuration.getApplicationContextPath()).thenReturn(contextPath);
