...
public class FileAppenderFactoryTest {
    ...
    public void includesCallerData() {
        ...
        AsyncAppender asyncAppender = (AsyncAppender) fileAppenderFactory
                .build(new LoggerContext(), "test", new SunflowerLayoutFactory(),
        ...
        asyncAppender = (AsyncAppender) fileAppenderFactory
                .build(new LoggerContext(), "test", new SunflowerLayoutFactory(),
                        new NullLevelFilterFactory<>(), new AsyncLoggingEventAppenderFactory());
    ...
    public void testCurrentLogFileNameIsEmptyAndAppenderUsesArchivedNameInstead() throws Exception {
        ...
        appenderFactory
                .setArchivedLogFilenamePattern(folder.newFile("test-archived-name-%d.log").toString());
        final FileAppender<ILoggingEvent> rollingAppender = appenderFactory
    ...
    public void hasMaxFileSize() throws Exception {
        ...
        final Field maxFileSizeField = SizeAndTimeBasedRollingPolicy.class
                .getDeclaredField("maxFileSize");
    ...
    public void overrideBufferSize() throws NoSuchFieldException, IllegalAccessException {
        ...
        assertThat(bufferSizeFromAppender.getSize())
                .isEqualTo(fileAppenderFactory.getBufferSize().toBytes());
    }
    ...
    public void isImmediateFlushed() throws Exception {
        ...
        AsyncAppender asyncAppender = (AsyncAppender) fileAppenderFactory.build(new LoggerContext(), "test", new SunflowerLayoutFactory(), new NullLevelFilterFactory<>(), new AsyncLoggingEventAppenderFactory());
        ...
        asyncAppender = (AsyncAppender) fileAppenderFactory.build(new LoggerContext(), "test", new SunflowerLayoutFactory(), new NullLevelFilterFactory<>(), new AsyncLoggingEventAppenderFactory());
