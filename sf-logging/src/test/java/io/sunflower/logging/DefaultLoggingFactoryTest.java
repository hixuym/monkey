...
public class DefaultLoggingFactoryTest {
    ...
    public void canParseNewLoggerFormat() throws Exception {
        ...
        final AppenderFactory<ILoggingEvent> appenderFactory = newAppConfiguration.getAppenders()
                .get(0);
        ...
        assertThat(fileAppenderFactory.getArchivedLogFilenamePattern())
                .isEqualTo("${new_app}-%d.log.gz");
        ...
        final ImmutableList<FilterFactory<ILoggingEvent>> filterFactories = fileAppenderFactory
                .getFilterFactories();
    ...
    public void testConfigure() throws Exception {
        ...
        final DefaultLoggingFactory config = factory.build(
                new SubstitutingSourceProvider(new FileConfigurationSourceProvider(), substitutor), configPath);
    ...
    public void testResetAppenders() throws Exception {
        ...
        final DefaultLoggingFactory config = factory
                .build(new FileConfigurationSourceProvider(), configPath);
        config.configure(new MetricRegistry(), "test-logger");
        ...
        final List<Appender<ILoggingEvent>> appenders = ImmutableList
