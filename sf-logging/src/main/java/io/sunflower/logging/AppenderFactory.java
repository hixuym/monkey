 ...
 * <p/>
 * To create your own, just: <ol> <li>Create a class which implements {@link AppenderFactory}.</li> <li>Annotate it with
 * {@code @JsonTypeName} and give it a unique type name.</li> <li>add a {@code META-INF/services/AppenderFactory} file
...
public interface AppenderFactory<E extends DeferredProcessingAware> extends Discoverable {
    /**
     * Given a Logback context, an application name, a layout, a levelFilterFactory, and an asyncAppenderFactory build a
     * new appender.
     *
