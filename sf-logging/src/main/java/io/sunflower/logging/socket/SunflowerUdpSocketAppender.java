 ...
 */
public class SunflowerUdpSocketAppender<E extends DeferredProcessingAware> extends OutputStreamAppender<E> {

    private final String host;
    private final int port;

    public SunflowerUdpSocketAppender(String host, int port) {
        this.host = host;
        this.port = port;
    }
