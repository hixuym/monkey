package io.sunflower.logging.socket;
 ...
 */
public class SunflowerSocketAppender<E extends DeferredProcessingAware> extends OutputStreamAppender<E> {
    ...
    public SunflowerSocketAppender(String host, int port, int connectionTimeoutMs, int sendBufferSize,
