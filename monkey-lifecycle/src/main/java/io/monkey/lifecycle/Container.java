...
public interface Container {
    ...
    /**
     * Add a bean.  If the bean is-a {@link Listener}, then also do an implicit {@link
    ...
    /**
     * A listener for Container events. If an added bean implements this interface it will receive the
    ...
    /**
     * Inherited Listener. If an added bean implements this interface, then it will be added to all
     * contained beans that are themselves Containers
     */
