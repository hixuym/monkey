...
package io.sunflower.inject.lifecycle;
 ...
 * <p/>
 * Note that a reference is held to this bean by the lifecycle system, if this bean is not a
 * singleton, and gets instantiated in response to regular events, you will run out of memory.
 * <p/>
 * Note: If this bean is provided by an @Provided method, then that method *must* be annotated with
 * @Singleton, otherwise it won't be detected.
 *
 * @author James Roper
 */
