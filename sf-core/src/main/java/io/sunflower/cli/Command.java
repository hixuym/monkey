...
public abstract class Command {
    ...
    /**
     * Method is called if there is an issue parsing configuration, setting up the environment, or running the command
     * itself. The default is printing the stacktrace to facilitate debugging, but can be customized per command.
     *
