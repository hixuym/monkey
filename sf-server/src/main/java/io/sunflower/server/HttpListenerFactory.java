 ...
 * <td>RFC7230</td>
 * <td>
 * This sets the server compliance level used by Jetty when parsing server, this can be useful when using a
 ...
 *
 * Possible values are set forth in the org.eclipse.jetty.server.HttpCompliance enum:
 * <ul>
 ...
 */
@JsonTypeName("server")
public class HttpListenerFactory implements ListenerFactory {
    public static ListenerFactory application() {
        final HttpListenerFactory factory = new HttpListenerFactory();
        factory.port = 8080;
        return factory;
    }

    public static ListenerFactory admin() {
        final HttpListenerFactory factory = new HttpListenerFactory();
        factory.port = 8081;
        return factory;
    }
