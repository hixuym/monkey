...
import io.sunflower.client.proxy.AuthConfiguration;
...
public class HttpClientBuilderTest {
    ...
    public void canUseACustomDnsResolver() throws Exception {
        ...
        final Field dnsResolverField = FieldUtils
                .getField(connectOperator.getClass(), "dnsResolver", true);
    ...
    public void usesASystemDnsResolverByDefault() throws Exception {
        final InstrumentedHttpClientConnectionManager manager = builder
                .createConnectionManager(registry, "test");
    ...
    public void canUseACustomHostnameVerifierWhenTlsConfigurationSpecified() throws Exception {
        ...
        final Registry<ConnectionSocketFactory> configuredRegistry;
        configuredRegistry = builder.using(configuration).using(customVerifier)
    ...
    @Test
    public void canUseASystemHostnameVerifierByDefaultWhenTlsConfigurationNotSpecified()
            throws Exception {
        final Registry<ConnectionSocketFactory> configuredRegistry;
    ...
    @Test
    public void canUseASystemHostnameVerifierByDefaultWhenTlsConfigurationSpecified()
            throws Exception {
        final TlsConfiguration tlsConfiguration = new TlsConfiguration();
        tlsConfiguration.setVerifyHostname(true);
        configuration.setTlsConfiguration(tlsConfiguration);
    ...
    public void createClientCanPassCustomVerifierToApacheBuilder() throws Exception {
        ...
        assertThat(builder.using(customVerifier).createClient(apacheBuilder, connectionManager, "test"))
                .isNotNull();

        final Field hostnameVerifierField =
                FieldUtils.getField(org.apache.http.impl.client.HttpClientBuilder.class, "hostnameVerifier",
                        true);
    ...
    public void usesKeepAliveForPersistentConnections() throws Exception {
        ...
        final DefaultConnectionKeepAliveStrategy strategy =
                (DefaultConnectionKeepAliveStrategy) spyHttpClientBuilderField("keepAliveStrategy",
                        apacheBuilder);
    ...
    public void usesDefaultForNonPersistentConnections() throws Exception {
        ...
        final DefaultConnectionKeepAliveStrategy strategy = (DefaultConnectionKeepAliveStrategy) field
                .get(apacheBuilder);
        final HttpContext context = mock(HttpContext.class);
        final HttpResponse response = mock(HttpResponse.class);
    ...
    public void disablesNaglesAlgorithm() throws Exception {
        ...
        assertThat(((SocketConfig) spyHttpClientBuilderField("defaultSocketConfig", apacheBuilder))
                .isTcpNoDelay()).isTrue();
    }
    ...
    public void usesTheDefaultRoutePlanner() throws Exception {
        ...
        assertThat(spyHttpClientField("routePlanner", httpClient))
                .isInstanceOf(DefaultRoutePlanner.class);
    }
        ...
        final HttpRoutePlanner routePlanner = new SystemDefaultRoutePlanner(new ProxySelector() {
            ...
            public List<Proxy> select(URI uri) {
                return ImmutableList
                        .of(new Proxy(Proxy.Type.HTTP, new InetSocketAddress("192.168.52.1", 8080)));
            }
    ...
    public void usesCredentialsProvider() throws Exception {
        ...
        assertThat(spyHttpClientBuilderField("credentialsProvider", apacheBuilder))
                .isSameAs(credentialsProvider);
    }
    ...
    public void usesProxyWithNtlmAuth() throws Exception {
        HttpClientConfiguration config = new HttpClientConfiguration();
        AuthConfiguration auth = new AuthConfiguration("secret", "stuff", "NTLM", "realm", "host",
                "domain", "NT");
        ProxyConfiguration proxy = new ProxyConfiguration("192.168.52.11", 8080, "http", auth);
        config.setProxyConfiguration(proxy);
    ...
    public void setValidateAfterInactivityPeriodFromConfiguration() throws Exception {
        ...
        configuration
                .setValidateAfterInactivityPeriod(Duration.milliseconds(validateAfterInactivityPeriod));
        final ConfiguredCloseableHttpClient client = builder.using(configuration)
                .createClient(apacheBuilder, builder.configureConnectionManager(connectionManager), "test");
    ...
    public void exposedConfigIsTheSameAsInternalToTheWrappedHttpClient() throws Exception {
        ...
        assertThat(spyHttpClientField("defaultConfig", client.getClient()))
    ...
    public void usesACustomRedirectStrategy() throws Exception {
        ...
        ConfiguredCloseableHttpClient client = builder.using(neverFollowRedirectStrategy)
                .createClient(apacheBuilder, connectionManager, "test");
        assertThat(client).isNotNull();
        assertThat(spyHttpClientBuilderField("redirectStrategy", apacheBuilder))
                .isSameAs(neverFollowRedirectStrategy);
    }
    ...
    public void configureCredentialReturnsNTCredentialsForNTLMConfig() throws Exception {
        AuthConfiguration ntlmConfig = new AuthConfiguration("username", "password", "NTLM", "realm",
                "hostname", "domain", "NT");
    ...
    private Object spyHttpClientBuilderField(final String fieldName, final Object obj)
            throws Exception {
