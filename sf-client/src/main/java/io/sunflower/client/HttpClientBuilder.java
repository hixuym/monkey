...
/**
 * A convenience class for building {@link HttpClient} instances. <p> Among other things, <ul> <li>Disables stale
 * connection checks by default</li> <li>Disables Nagle's algorithm</li> <li>Disables cookie management by default</li>
 * </ul> </p>
 */
public class HttpClientBuilder {
     ...
     *
     * Intended for use by subclasses to inject HttpClientBuilder configuration. The default implementation is an
     * identity function.
     */
    ...
    /**
     * Create a user agent string using the configured user agent if defined, otherwise using a combination of the
     * environment name and this client name
     *
    ...
    /**
     * Create a InstrumentedHttpClientConnectionManager based on the HttpClientConfiguration. It sets the maximum
     * connections per route and the maximum total connections that the connection manager can create
     *
