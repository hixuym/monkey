...
public class SSLConnectionSocketFactory {
  ...
  public org.apache.http.conn.ssl.SSLConnectionSocketFactory getSocketFactory()
    ...
    return new org.apache.http.conn.ssl.SSLConnectionSocketFactory(buildSslContext(),
        getSupportedProtocols(), getSupportedCiphers(),
  ...
  private void loadKeyMaterial(SSLContextBuilder sslContextBuilder) throws Exception {
    if (configuration.getKeyStorePath() != null) {
      final KeyStore keystore = loadKeyStore(configuration.getKeyStoreType(),
  ...
  private void loadTrustMaterial(SSLContextBuilder sslContextBuilder) throws Exception {
    ...
    if (configuration.getTrustStorePath() != null) {
      trustStore = loadKeyStore(configuration.getTrustStoreType(),
