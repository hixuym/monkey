...
public class YamlConfigurationFactoryTest extends BaseConfigurationFactoryTest {
    ...
    public void setUp() throws Exception {
        this.factory = new YamlConfigurationFactory<>(Example.class, validator, Jackson.newObjectMapper(), "mk");
    ...
    public void throwsAnExceptionOnMalformedFiles() {
        assertThatThrownBy(super::throwsAnExceptionOnMalformedFiles)
            .hasMessageContaining(" * Failed to parse configuration; Cannot construct instance of `io.monkey.configuration.BaseConfigurationFactoryTest$Example`");
    }
