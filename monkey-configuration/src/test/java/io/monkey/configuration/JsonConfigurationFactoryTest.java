...
public class JsonConfigurationFactoryTest extends BaseConfigurationFactoryTest {
    ...
    public void setUp() throws Exception {
        this.factory = new JsonConfigurationFactory<>(Example.class, validator, Jackson.newObjectMapper(), "mk");
    ...
    public void configuredMapperAllowsComment() throws IOException, ConfigurationException {
        ...
        JsonConfigurationFactory<Example> factory = new JsonConfigurationFactory<>(Example.class, validator, mapper, "mk");
