...
public class SslContextFactory {
    ...
    private static final Logger LOG_CONFIG = LoggerFactory.getLogger("config");
    ...
    //(value = "The selected TLS protocol versions", readonly = true)
    public String[] getSelectedProtocols() {
        return Arrays.copyOf(_selectedProtocols, _selectedProtocols.length);
    }

    //(value = "The selected cipher suites", readonly = true)
    ...
    //("Whether to respect the cipher suites order")
    ...
    public void setKeyStorePath(String keyStorePath) {
        try {
            _keyStoreResource = URI.create(keyStorePath);
        } catch (Exception e) {
    ...
    public void setTrustStorePath(String trustStorePath) {
        try {
            _trustStoreResource = URI.create(trustStorePath);
        } catch (Exception e) {
            throw new IllegalArgumentException(e);
        }
    }
     ...
     * Whether client authentication is wanted
     */
     ...
     * Whether certificates are validated
     */
     ...
     * Whether peer certificates are validated
     */
    ...
    /**
     * Whether certificates should be trusted even if they are invalid
     *
     ...
     * The max number of renegotiations allowed
     */
     ...
     * The maximum number of intermediate certificates
     */
    ...
    protected Collection<? extends CRL> loadCRL(String crlPath) throws Exception {
        if (Strings.isNullOrEmpty(crlPath)) {
            return null;
        }
        return CertificateUtils.loadCRL(URI.create(crlPath));
    }
     ...
     * Whether certificate revocation list distribution points is enabled
     */
     ...
     * Whether online certificate status protocol support is enabled
     */
     ...
     *
     * @return SSL session cache size The maximum TLS session cache size
     */
     ...
     * The TLS session cache timeout, in seconds
     *
