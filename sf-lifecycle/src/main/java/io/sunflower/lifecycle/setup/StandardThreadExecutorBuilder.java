...
public class StandardThreadExecutorBuilder {
    ...
    public StandardThreadExecutorBuilder(LifecycleEnvironment environment, String nameFormat, ThreadFactory factory) {
    ...
    public StandardThreadExecutor build() {
        ...
        StandardThreadExecutor executor = new StandardThreadExecutor(minWorkerThread, maxWorkerThread, workerQueueSize, threadFactory);
