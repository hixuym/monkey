...
public class TemplateEngineFreemarker implements TemplateEngine {
    ...
    public TemplateEngineFreemarker(Messages messages,
                                    ...
                                    TemplateEngineFreemarkerWebJarsAtMethod templateEngineFreemarkerWebJarsAtMethod) throws Exception {
        ...
        cfg.setDefaultEncoding(GizmoConstant.UTF_8);

        // Set the charset of the output. This is actually just a hint, that
        // templates may require for URL encoding and for generating META element
        // that uses http-equiv="Content-type".
        cfg.setOutputEncoding(GizmoConstant.UTF_8);
